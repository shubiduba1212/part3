...
public class AuthDetails implements UserDetails {
  ...
  *  UsernameIdAuthenticationToken과 사용자의 아이디를 비교할 때 사용한다. */
  @Override
  ...
  /* 잠겨 있는 계정을 확인하는 메소드로 false 이면 해당 계정을 사용할 수 없다.
  *  비밀번호 반복 실패로 일시적인 계정 lock인 경우 혹은 오랜 시간 비 접속으로 휴면 처리 */
  @Override
  ...
  *  보통 데이터 삭제는 즉시 하는 것이 아닌 일정 기간 보관 후 삭제한다. */
  ...
  /* 계정 비활성화 여부로 사용자가 사용할 수 없는 상태 표현하는 메소드로
